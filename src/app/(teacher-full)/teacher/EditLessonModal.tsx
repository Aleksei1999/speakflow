...
// EditLessonModal — перенос даты/времени урока. Та же модалка, что «Добавить
// урок» (Figma 2522:2506 / 2522:696 / 2522:2546); переиспользует PickerList и
// иконки из AddLessonModal. Сабмит → rescheduleLesson, затем router.refresh().
